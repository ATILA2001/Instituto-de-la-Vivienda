...
namespace Negocio
{
    public class CertificadoNegocioEF
    {
        ...
        /// Esencial para el patr�n de "recuperar y modificar".
        /// </summary>
        ...
        public CertificadoEF ObtenerPorId(int id)
        {
            using (var context = new IVCdbContext())
            {
                // Find es la forma m�s eficiente de obtener una entidad por su clave primaria.
        ...
        /// <summary>
        /// Actualiza únicamente el porcentaje de ejecución física de un certificado.
        /// </summary>
