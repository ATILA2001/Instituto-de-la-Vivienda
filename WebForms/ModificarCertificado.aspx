<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="ModificarCertificado.aspx.cs" Inherits="WebForms.ModificarCertificado" %>
                        ...
                        <table class="table  table-3d">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlAutorizante" CssClass="form-control" runat="server" Enabled="false"></asp:DropDownList>
                                    </td>
