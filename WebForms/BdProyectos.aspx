...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
						...
						<div class="container">
							<div class="row">
								...
								<div class="col-6">
									...
									<div class="mb-3">
										<label for="txtMontoAutorizado2026" class="form-label">Monto Autorizado 2026</label>
										<asp:TextBox ID="txtMontoAutorizado2026" CssClass="form-control" runat="server" placeHolder="0,00" />
										<asp:RequiredFieldValidator ID="rfvMontoAutorizado"
											ControlToValidate="txtMontoAutorizado2026"
		...
		<div class="gridview-scroll-container">
			...
			<asp:GridView ID="dgvBdProyecto" DataKeyNames="Id" CssClass="table1 table-bordered table-hover mb-4"
				...
				<Columns>
					...
					<asp:BoundField HeaderText="Autorizado 2025" DataField="Autorizado2025" DataFormatString="{0:C}" />
					<asp:BoundField HeaderText="Autorizado 2026" DataField="Autorizado2026" DataFormatString="{0:C}" />
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			$('#<%= txtMontoAutorizado2026.ClientID %>').on('change keyup', function () {
		...
		function limpiarFormulario() {
			...
			document.getElementById('<%= txtMontoAutorizado2026.ClientID %>').value = '';
