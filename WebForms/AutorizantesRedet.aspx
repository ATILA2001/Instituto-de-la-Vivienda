			...
			<asp:GridView ID="dgvAutorizante" DataKeyNames="CodigoAutorizante" CssClass="table1  table-bordered table-hover mb-4"
				...
				<Columns>
					...
					<asp:TemplateField HeaderText="Contrata">
						<HeaderTemplate>
							<CustomControls:TreeViewSearch ID="cblsHeaderContrata" runat="server" HeaderText="Contrata" DataTextField="Nombre" DataValueField="Id" OnAcceptChanges="OnAcceptChanges" />
						</HeaderTemplate>
						<ItemTemplate>
							<%# Eval("Obra.Contrata.Nombre") %>
						</ItemTemplate>
					</asp:TemplateField>
					...
					<asp:TemplateField HeaderText="Código Autorizante">
						<HeaderTemplate>
							<CustomControls:TreeViewSearch ID="cblsHeaderCodigoAutorizante" runat="server" HeaderText="Código Autorizante" DataTextField="CodigoAutorizante" DataValueField="CodigoAutorizante" OnAcceptChanges="OnAcceptChanges" />
						</HeaderTemplate>
						<ItemTemplate>
