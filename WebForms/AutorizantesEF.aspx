...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
								...
								<div class="col-6">
									<div class="mb-3">
										...
										<asp:RegularExpressionValidator ID="revMontoAutorizadoAgregar"
											...
											ErrorMessage="Solo nÃºmeros positivos con hasta 2 decimales"
											Display="Dynamic"
											CssClass="text-danger"
											EnableClientScript="true" />
									</div>
	...
	<!-- Modal Gestionar Presupuesto -->
	<div class="modal fade" id="modalGestionarPresupuesto" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h1 class="modal-title fs-5" id="tituloModalPresupuesto">Gestionar Presupuesto</h1>
					<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
				</div>
				<div class="modal-body">
					<div class="form-group">
						<div class="container">
							...
							<div class="row">
								<div class="col-6">
									<div class="mb-3">
										<label for="txtImportePresupuesto" class="form-label">Importe *</label>
										<asp:TextBox ID="txtImportePresupuesto" CssClass="form-control" runat="server" placeHolder="0,00" />
										<asp:RequiredFieldValidator ID="rfvImportePresupuesto"
											ControlToValidate="txtImportePresupuesto"
											ValidationGroup="GestionarPresupuesto"
											runat="server"
											ErrorMessage="El importe es requerido"
											Display="Dynamic"
											CssClass="text-danger"
											EnableClientScript="true" />
										<asp:RegularExpressionValidator ID="revImportePresupuesto"
											ControlToValidate="txtImportePresupuesto"
											ValidationGroup="GestionarPresupuesto"
											runat="server"
											ValidationExpression="^[0-9]+([,][0-9]{1,2})?$"
								...
								<div class="col-6">
									<div class="mb-3">
										<label for="txtFechaNormaPresupuesto" class="form-label">Fecha Norma *</label>
										<asp:TextBox ID="txtFechaNormaPresupuesto" CssClass="form-control" runat="server" TextMode="Date" />
										<asp:RequiredFieldValidator ID="rfvFechaNormaPresupuesto"
											ControlToValidate="txtFechaNormaPresupuesto"
											ValidationGroup="GestionarPresupuesto"
											runat="server"
											ErrorMessage="La fecha de norma es requerida"
											Display="Dynamic"
											CssClass="text-danger"
											EnableClientScript="true" />
									</div>
								...
								<div class="col-12">
									<div class="mb-3">
										<label for="txtNormaPresupuesto" class="form-label">Norma *</label>
										<asp:TextBox ID="txtNormaPresupuesto" CssClass="form-control" runat="server" placeHolder="Ej: Resolución 2025-001" MaxLength="255" />
										<asp:RequiredFieldValidator ID="rfvNormaPresupuesto"
											ControlToValidate="txtNormaPresupuesto"
											ValidationGroup="GestionarPresupuesto"
											runat="server"
											ErrorMessage="La norma es requerida"
											Display="Dynamic"
											CssClass="text-danger"
											EnableClientScript="true" />
									</div>
				...
				<div class="modal-footer d-flex justify-content-between px-4">
					<asp:LinkButton ID="btnEliminarPresupuesto" runat="server"
						CssClass="btn btn-outline-secondary"
						OnClick="btnEliminarPresupuesto_Click"
						OnClientClick="return confirm('¿Está seguro que desea eliminar el presupuesto de este autorizante?');"
						Visible="false">
 <i class="bi bi-trash3-fill"></i> 
					</asp:LinkButton>
					<div class="d-flex gap-4">
						<button type="button" class="btn btn-danger" data-bs-dismiss="modal"><i class="bi bi-x-lg"></i></button>
						<asp:Button Text="Guardar" ID="btnGuardarPresupuesto" OnClick="btnGuardarPresupuesto_Click"
							CssClass="btn btn-success" runat="server" ValidationGroup="GestionarPresupuesto" />
					</div>
				</div>
			</div>
		</div>
				...
				<asp:TemplateField HeaderText="Acciones">
					<ItemTemplate>
						<div class="d-flex justify-content-center gap-2">
							...
							<asp:LinkButton ID="btnGestionarPresupuesto" runat="server"
								CommandName="GestionarPresupuesto"
								OnClick="btnGestionarPresupuesto_Click"
								CssClass="btn btn-sm btn-success"
								ToolTip="Gestionar Presupuesto"
								Visible="false">
	...
	<!-- Control de paginaciÃ³n reutilizable -->
	...
	<script type="text/javascript">
		...
		function limpiarFormularioPresupuesto() {
			document.getElementById('<%= txtImportePresupuesto.ClientID %>').value = '';
			document.getElementById('<%= txtNormaPresupuesto.ClientID %>').value = '';
			document.getElementById('<%= txtFechaNormaPresupuesto.ClientID %>').value = '';
		}
	</script>
</asp:Content>
