		...
		<div class="modal-dialog modal-dialog-centered modal-lg">
			<div class="modal-content">
				...
				<div class="modal-footer d-flex justify-content-between px-4">
					<button type="button" class="btn btn-outline-secondary" id="btnLimpiarAgregar" onclick="limpiarFormularioAgregar()" data-bs-toggle="tooltip" title="Limpiar formulario"><i class="bi bi-trash3-fill"></i></button>
	...
	<div class="modal fade" id="modalEditarAutorizante" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-lg">
			<div class="modal-content">
				...
				<div class="modal-footer d-flex justify-content-between px-4">
					<button type="button" class="btn btn-outline-secondary" id="btnLimpiarEditar" onclick="limpiarFormularioEditar()" data-bs-toggle="tooltip" title="Limpiar formulario"><i class="bi bi-trash3-fill"></i></button>
					<div class="d-flex gap-2">
						<button type="button" class="btn btn-danger" data-bs-dismiss="modal" data-bs-toggle="tooltip" title="Cancelar"><i class="bi bi-x-lg"></i></button>
					</div>
				</div>
