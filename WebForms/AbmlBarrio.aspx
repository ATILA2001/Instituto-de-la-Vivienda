    ...
    <div class="container-fluid mt-4">
        <div class="row">
            <div class="col-md-8 border-end">
                ...
                <asp:GridView ID="dgvBarrio" DataKeyNames="ID" CssClass="table " 
              ...
              PageSize="10" OnPageIndexChanging="dgvBarrio_PageIndexChanging">
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Barrio" DataField="Nombre"  HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#f1c40f" HeaderStyle-HorizontalAlign="Center" />
