...
SELECT u.ID,u.NOMBRE,TIPO,CORREO,ESTADO,a.NOMBRE FROM USUARIOS as u inner join AREAS as a on AREA = a.ID
CREATE TABLE
    OBRAS (
        ID INT IDENTITY (1, 1) PRIMARY KEY,
        AREA INT NOT NULL,
...
CREATE TABLE
    AUTORIZANTES (
        ID INT IDENTITY (1, 1) PRIMARY KEY,
        OBRA INT,
        CODIGO_AUTORIZANTE VARCHAR(50) UNIQUE NOT NULL,
        DETALLE VARCHAR(255),
...
(1, 1, 80, 1, '2023', 0, 0, 'Rodrigo Bueno', 'Borde Costero-Contencion Macizo'),
(2, 2, NULL, 2, NULL, NULL, NULL, 'Fraga', 'Mantenimiento integral'),
(2, 3, 68, 3, '2023', NULL, NULL, 'VILLA 15', 'Recuperación de fachadas y trabajos complementarios'),
(2, 4, 9, 4, '2023', NULL, NULL, 'Piedrabuena', 'Piedrabuena - Recup. y renov. inst. de gas');

INSERT INTO AUTORIZANTES (OBRA, CODIGO_AUTORIZANTE, DETALLE, CONCEPTO, ESTADO, EXPEDIENTE, MONTO_AUTORIZADO, AUTORIZACION_GG) VALUES 
(1, '1-00', 'Obra Basica', 'Basica', 1, '44385963/23', 898753854.00, 1),
(3, '3-00', 'Obra Basica', 'Basica', 1, '33049761/23', 53809013.20, 1),
(3, '3-1', 'Adenda 1', 'Adenda', 3, NULL, NULL, 1),
(4, '4-00', 'Obra Basica', 'Basica', 1, '05567301/23', 95251093.00, 1),
(4, '4-1', 'Adicional 01', 'Adicional', 1, '14243383/24', 3006811.19, 1),
(4, '4-00-R1', 'Obra Basica REDET 01', 'Basica', 1, '05567301/23', 3006811.19, 1),
(4, '4-1-R1', 'Adicional REDET 01', 'Adicional', 1, '14243383/24', 3006811.19, 1);
...
('1-00', '35398238/24', 1, 89875385.45, '2024-09-01'),
('1-00', '43018058/24', 2, 103904672.40, '2024-10-01'),
('1-00', '45381115/24', 2, 138884433.13, '2024-11-01'),
('1-00', NULL, 2, 136134246.34, '2024-12-01'),
('1-00', NULL, 2, 114860742.60, '2025-01-01'),
('1-00', NULL, 2, 116640275.24, '2025-02-01'),
('1-00', NULL, 2, 101352472.17, '2025-03-01'),
('1-00', NULL, 2, 97065416.28, '2025-04-01'),
('4-00', '37048873/23', 1, 14287664.00, '2023-10-01'),
('4-00', '01487314/24', 2, 8774302.66, '2023-12-01'),
('4-00', '05996239/24', 2, 4531030.95, '2024-01-01'),
('4-00', '10435888/24', 2, 10474191.66, '2024-02-01'),
('4-00', '13279211/24', 2, 9815034.88, '2024-03-01'),
('4-00', '16896366/24', 2, 12799777.99, '2024-04-01'),
('4-00', '22660767/24', 2, 9088213.12, '2024-05-01'),
('4-00', NULL, 2, 1500000.00, '2024-11-01'),
('4-00', '25839020/24', 2, 15391340.41, '2024-06-01'),
('4-00', '29355102/24', 2, 3683892.59, '2024-07-01'),
('4-00', '34121717/24', 2, 3741706.56, '2024-08-01'),
('4-00', '38571234/24', 2, 1500000.00, '2024-09-01'),
('4-00', '42977092/24', 2, 1740868.76, '2024-10-01'),
('4-00', NULL, 2, 1500000.00, '2024-12-01'),
('4-1', '29348658/24', 2, 7899813.59, '2024-07-01'),
('4-1', '34538730/24', 2, 7899813.58, '2024-08-01'),
('4-1', '38853348/24', 2, 85945.56, '2024-09-01'),
('4-1', '42788007/24', 2, 244153.44, '2024-10-01'),
('4-1', NULL, 2, 287662.00, '2024-12-01'),
('4-00-R1', NULL, 3, NULL, '2023-10-01'),
('4-00-R1', NULL, 3, NULL, '2023-11-01'),
('4-00-R1', '05562840/24', 3, 6402656.15, '2023-12-01'),
('4-00-R1', '05996239/24', 3, 3332274.20, '2024-01-01'),
('4-00-R1', '10435888/24', 3, 8116007.94, '2024-02-01'),
('4-00-R1', '13279211/24', 3, 7605255.24, '2024-03-01'),
('4-00-R1', '16896366/24', 3, 7641278.91, '2024-04-01'),
('4-00-R1', '22660767/24', 3, 6796672.45, '2024-05-01'),
('4-00-R1', '25839020/24', 3, 11746604.18, '2024-06-01'),
('4-00-R1', '29355102/24', 3, 2861608.54, '2024-07-01'),
('4-00-R1', '34121717/24', 3, 3097852.36, '2024-08-01'),
('4-00-R1', '38591234/24', 3, 1757783.37, '2024-09-01'),
('4-00-R1', '42977092/24', 3, 1270362.48, '2024-10-01'),
('4-00-R1', NULL, 3, 1094593.55, '2024-11-01'),
('4-00-R1', NULL, 3, 1094593.55, '2024-12-01'),
('4-1-R1', NULL, 3, NULL, '2023-10-01'),
('4-1-R1', NULL, 3, NULL, '2023-11-01'),
('4-1-R1', NULL, 3, NULL, '2023-12-01'),
('4-1-R1', NULL, 3, NULL, '2024-01-01'),
('4-1-R1', NULL, 3, NULL, '2024-02-01'),
('4-1-R1', NULL, 3, NULL, '2024-03-01'),
('4-1-R1', NULL, 3, NULL, '2024-04-01'),
('4-1-R1', NULL, 3, NULL, '2024-05-01'),
('4-1-R1', NULL, 3, 0.81, '2024-06-01'),
('4-1-R1', '29348658/24', 3, 5436454.26, '2024-07-01'),
('4-1-R1', '34538730/24', 3, 5436454.26, '2024-08-01'),
('4-1-R1', '38853348/24', 3, 69685.52, '2024-09-01'),
('4-1-R1', '42788007/24', 3, 197962.06, '2024-10-01'),
('4-1-R1', NULL, 3, 233239.24, '2024-11-01'),
('4-1-R1', NULL, 3, 233239.24, '2024-12-01');
...
-- SELECT OBRAS
SELECT O.ID,A.NOMBRE AS AREA,E.NOMBRE AS EMPRESA,NUMERO,C.NOMBRE AS CONTRATA,AÑO,ETAPA,OBRA,BARRIO,DESCRIPCION FROM OBRAS AS O 
...
--
SELECT CONCAT(C.NOMBRE,' ',O.NUMERO,'/',O.AÑO) AS CONTRATA, O.DESCRIPCION AS OBRA, CODIGO_AUTORIZANTE, DETALLE, CONCEPTO,E.NOMBRE AS ESTADO, EXPEDIENTE, MONTO_AUTORIZADO, AUTORIZACION_GG,B.AUTORIZADO_NUEVO FROM AUTORIZANTES AS A
...
--
SELECT CONCAT(CO.NOMBRE,' ',O.NUMERO,'/',O.AÑO) AS CONTRATA, O.DESCRIPCION, C.CODIGO_AUTORIZANTE, EXPEDIENTE_PAGO, T.NOMBRE, MONTO_TOTAL, MES_APROBACION, A.MONTO_AUTORIZADO, FORMAT((MONTO_TOTAL / A.MONTO_AUTORIZADO) * 100, 'N2') AS PORCENTAJE, B.AUTORIZADO_NUEVO FROM CERTIFICADOS AS C
...
VALUES ('beas', '12233@gmail.com', '1223',1,1,2);